...
const meta = {
  ...
  argTypes: {
    ...
    isEscCloseable: { control: { type: 'boolean' }, description: 'ESC로 닫힘 여부' },
    hideScrim: {
      control: { type: 'boolean' },
    ...
    return (
      <div style={{ display: 'flex', alignItems: 'center', padding: '30 10' }}>
        ...
        <Modal
          ...
          size='medium'
          position='center'
          context={{ isOpen: isFirstChildOpen, onOpen: onFirstChildOpen, onClose: onFirstChildClose }}
        >
          <Modal.Layout>
        ...
        <Modal
          ...
          size='small'
          position='bottom'
          context={{ isOpen: childTryClose, onOpen: onFirstChildClose, onClose: childHandleConfirmClose }}
        >
          <Modal.Layout>
